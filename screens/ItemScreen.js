    ...
    <SafeAreaView className="flex-1 bg-white relative">
        <ScrollView className="flex-1 px-4 py-6">
            <View className="relative bg-white shadow-lg">
                ...
                <View className="flex-row inset-0 bottom-5 justify-between px-6">
                    <View className="flex-row items-center space-x-2">
                        <Text className="text-[12px] font-bold text-[#3C6072]">
                            {data?.price_level}
                        </Text>
                        <Text className="text-[18px] font-bold text-[#3C6072]">
                            {data?.price}
                        </Text>
                    </View>
            ...
            <View className="mt-6">
                ...
                <View className="flex-row items-center space-x-2 mt-2">
                    ...
                    <Text
                    className="text-[#8C9EA6] text-[20px] font-bold">
            ...
            <View className="space-y-2 mt-4 bg-gray-100 rounded-2xl px-4 py-2">
                {data?.phone && (
                    <View className="flex-row items-center space-x-6">
                        ...
                        <Text className="text-lg capitalize">{data?.phone}</Text>
                    </View>
                )}
                {data?.email && (
                    <View className="flex-row items-center space-x-6">
                        <FontAwesome name='envelope' size={24} color="#428288"/> 
                        <Text className="text-lg capitalize">{data?.email}</Text>
                    </View>
                )}
                {data?.address && (
                    <View className="flex-row items-center space-x-6">
                        <FontAwesome name='map-pin' size={24} color="#428288"/> 
                        <Text className="text-lg capitalize">{data?.address}</Text>
                    </View>
                )}
